...
import { Blocks, Eye, Handshake, Layers3, Rocket, ShieldCheck } from 'lucide-react';
...
const values = [
  {
    icon: Handshake,
    title: 'Client First',
    description: 'Every roadmap starts with outcomes, constraints, and measurable business value.',
  },
  {
    icon: ShieldCheck,
    title: 'Deep Expertise',
    description: 'AI, data, product, and cloud specialists working through enterprise complexity.',
  },
  {
    icon: Blocks,
    title: 'Collaboration',
    description: 'Integrated delivery squads that align product, engineering, and operations.',
  },
  {
    icon: Rocket,
    title: 'Agile',
    description: 'Fast validation cycles that move from experiment to production with discipline.',
  },
  {
    icon: Eye,

        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-2">
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                <div className="relative h-full w-full rounded-[1.75rem] transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                  ...
                  {/* Back */}
                  <div className="absolute inset-0 rounded-[1.75rem] bg-secondary p-7 shadow-[0_24px_60px_rgba(15,23,42,0.08)] [backface-visibility:hidden] [transform:rotateY(180deg)] md:p-9">

...
export default function Footer() {
  return (
    <footer className="bg-[#4d98a5] text-slate-100">
      <div className="container space-y-12 py-16">
        <div className="grid gap-10 lg:grid-cols-[1.6fr_1fr_1fr_1.2fr]">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-white/10 text-white">
                <img src="/img/logo.png" alt="InvoLead Logo" className="h-6 w-6" />
              </div>
              <div>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-200/80">
              Quick Link
            </h3>
